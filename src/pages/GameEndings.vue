...
<template>
  ...
  <InfoCard :categories="['Ending', 'Condition', 'Images', 'End Message']">
    ...
    <template #1>
      ...
      <p>
        Then you are shown a terminal in which it explains what happens to you. You are terminated
        and converted by some mysterious beings. In this ending you kill and convert everything on
        Earth. This is the result of the Evil spreading towards Earth.
      </p>
      <SpoilerBlock>
        <p>
          While it is unknown who types out this message, it has been theorized to be the Arirals.
          The reason for this is the due to the fact that the only race that has gotten close to Dr
          Kel is the Arirals. So it would explain the Subject and State lines for it. This also
          explains the summary they give for Earth especially after what just happened to it. The
          conclusion they give seems to align with their mission and story.
        </p>
  ...
  <InfoCard :categories="['Ending', 'Condition', 'Images', 'End Message']">
    <template #0> <h3 class="CardTitle" id="rufus">Secret Rufus Ending</h3> </template>
    <template #1>
      <p>
        There is no way to obtain this ending in the newer versions as the developers have removed
        the
        ...
        <a href="../ConsoleCommands/consolecommandswiki.html#rufus">Console Command</a>. Soon after
        a
        <a href="../Entities/entitieswiki.html#rufus">Rufus Entity</a>
        will spawn in your world and will begin chasing you down. You can either walk in the
        direction of the
  ...
  <InfoCard :categories="['Ending', 'Condition', 'Images', 'End Message']">
    <template #0> <h3 class="CardTitle" id="badsun">Bad Sun Ending</h3> </template>
    <template #1>
      <p>
        When the
      ...
      <p>
        ...
        <a href="#worst">Worst Ending</a> and <a href="#rufus">Secret Rufus Ending</a>. However in
        this one, more mysterious beings annihilate the sun and capture light.
      </p>
      <SpoilerBlock>
        <p>
          It is also unknown who types out this message but it is theorized to be Rozitals. Since
          this message is very robotic like and mentions "All Units". This disproves the group of 3
          Arirals present in this scene and would most likely align with the periodic Rozital
          entities that show up. Another thing to consider is the fact that the Rozitals don't know
          who Dr Kel is and don't interact with him. Due to this, the Rozitals only state only broad
          things such as "Location: Solar System" and "Status Unknown".
        </p>
      </SpoilerBlock></template
    >
    <template #2>
      <WidgetBundle>
        ...
        <ImageViewer src="/Images/GameEndings/10.png" alt="VOTV Archive Image" /> </WidgetBundle
    ></template>
    <template #3>
      <TerminalTranscript>
        >BEGIN<br />
        ...
        STATUS: UNKNOWN<br />
        <br />
        CONCLUSION: IGNORE PROTOCOLS, ANNIHILATE THE SUN, RETRIEVE ALL UNITS, CAPTURE THE REMAINING
        LIGHT.<br />
        <br />
        >END<br />
        <br />
