...
<template>
  ...
  <h3 id="burgerdream">Burger Dream</h3>
  <h4>Goal:</h4>
  <p id="9">
  ...
  <h4>Tips:</h4>
  <p id="10">
    Be careful not to jump in between burgers otherwise you will fall. To avoid this simply jump and
    crouch at the same time.
  </p>
  ...
  <h4>Description:</h4>
  <p id="11">
    The burger dream is a dream consisting of only burgers. The entire structure of burgers is that
    of a coil with a maze like shape.
  </p>
  ...
  <h3 id="manndream">Mannequin Dream</h3>
  <h4>Goal:</h4>
  <p id="12">
    The goal of this dream is to survive for 120 seconds or 2 minutes without being hit or touched
    by the
  ...
  <h4>Tips:</h4>
  <p id="13">
    The best way to do this is to run around the entire main chamber in a circle avoiding all the
    entities together.
  </p>
  ...
  <h3 id="rundream">Corridor Dream</h3>
  <h4>Goal:</h4>
  <p id="15">
  ...
  <h4>Tips:</h4>
  <p id="16">
    As soon as the Corridor Dream starts you want to look away and start running towards the long
    corridor, keep running as the
    <a href="../Entities/entitieswiki.html#whitem">White Mist</a>
    cannot outpace you.
  </p>
  <h4>Description:</h4>
  <p id="17">Long hallway, very claustrophobic.</p>
  ...
  <h3 id="1">Room Dream</h3>
  <h4>Goal:</h4>
  <p id="18">Survive the crushing impact of all the walls near you.</p>

  <ImageViewer src="/Images/Dreams/16.png" alt="VOTV Archive Image" />

  <h4>Tips:</h4>
  <p id="19">Jump inside the metal desk and wait it out.</p>
  ...
  <h4>Description:</h4>
  <p id="20">
    A large chamber with moving walls that get closer and closer, the walls will keep closing until
    the player has completed the dream.
  </p>
  ...
  <h3 id="drowndream">Fill Dream</h3>
  <h4>Goal:</h4>
  <p id="21">Find a door in a pillar and escape</p>

  <ImageViewer src="/Images/Dreams/21.png" alt="VOTV Archive Image" />

  <h4>Tips:</h4>
  <p id="22">
    The best way to complete this dream is to start in the middle and go diagonal while looking at
    all the sides of all the pillars as you walk on.
  </p>
  ...
  <h3 id="climbdream">Climb Dream</h3>
  <h4>Goal:</h4>
  <p id="24">Reach to the door and escape</p>
  ...
  <h3 id="jumpdream">Jump Dream</h3>
  <h4>Goal:</h4>
  <p id="27">Find a door on top of a platform and escape</p>

  <ImageViewer src="/Images/Dreams/29.png" alt="VOTV Archive Image" />

  <h4>Tips:</h4>
  <p id="28">
    First you want to look around and find which corner is the door occupied in, from there begin
    jumping onto the circular pillars and also utilizing the climb mechanic while you are doing so.
    And do not fall into the
    <a href="../Entities/entitieswiki.html#anomalwat">Anomalous Water</a>.
  </p>
  ...
  <p id="29">
    ...
    heights. The
    <a href="../Entities/entitieswiki.html#anomalwat">Anomalous Water</a>
    rises up very slowly hence giving you a lot of time to complete this dream. The door is located
    on one of the four corners, however there is a second door in which it may be bugged since it
    doesn't do anything.
  </p>
  ...
  <h3 id="wendidream">Furfur Dream</h3>
  <h4>Goal:</h4>
  <p id="30">Wait out the dream, no escape</p>

  <ImageViewer src="/Images/Dreams/33.png" alt="VOTV Archive Image" />

  <h4>Tips:</h4>
  <p id="31">No way to complete this dream, its a timed one.</p>
  ...
  <h3 id="ufodream">UFO Dream</h3>
  <h4>Goal:</h4>
  <p id="33">Wait out the dream, no escape</p>

  <ImageViewer src="/Images/Dreams/37.png" alt="VOTV Archive Image" />

  <h4>Tips:</h4>
  <p id="34">No way to complete this dream, its a timed one.</p>
  <h4>Description:</h4>
  <p id="35">
  ...
  <h3 id="2">Base Dream</h3>
  <h4>Goal:</h4>
  <p id="36">Wait out the dream, no escape</p>

  <ImageViewer src="/Images/Dreams/41.png" alt="VOTV Archive Image" />

  <h4>Tips:</h4>
  <p id="37">No way to complete this dream, its a timed one.</p>
  ...
  <p id="38">
    ...
    mannequin but colored checkered black and white squares. This dream is no longer accessible in
    the newer versions of the game, it used to be the only dream in the older versions.
  </p>
