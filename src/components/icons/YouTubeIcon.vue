...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" :width="s" :height="s" :viewBox="`0,0,256,256`"
       style="fill:#000000;">
    <g :fill="c" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter"
